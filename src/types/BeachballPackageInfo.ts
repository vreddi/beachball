...
import { PackageOptions, BeachballOptions, VersionGroupOptions } from './BeachballOptions';
...
export interface PackageGroupInfo extends Omit<VersionGroupOptions, 'include' | 'exclude'> {
  packageNames: string[];
}

export type PackageGroups = { [groupName: string]: PackageGroupInfo };
